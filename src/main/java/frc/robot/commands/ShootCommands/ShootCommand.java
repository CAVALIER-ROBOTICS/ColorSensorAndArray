...
public class ShootCommand extends CommandBase {
  ...
  public boolean hasRemoved = false; //this is because whenever you remove an entry, everything else shifts, so you probably have to prevent one beam break from clearing the table
  ...
  public void execute() {
    ...
    if(beamBreak.get() && ColorSensor.getBallState().size()>0 && !hasRemoved) {
