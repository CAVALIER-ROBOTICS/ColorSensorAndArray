...
import frc.robot.ColorSensor.colorStates;
...
public class Limelight {
   ...
   // public static boolean led = true;
    ...
    public static ledModes getCurrentMode() {
        return currentMode;
    }
    ...
    public static double getHoodsetPoint() {
        ...
        colorStates willBeShot = null;
        if(ColorSensor.getBallState().size()>0 ) {
            willBeShot = ColorSensor.getBallState().get(0);
        }
        else if(ColorSensor.getBallState().size() == 0) {
